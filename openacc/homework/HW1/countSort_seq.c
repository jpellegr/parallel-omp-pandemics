...
int main(int argc, char *argv[]) {
    double start,end;
    //start=c_get_wtime();
    // simple hard-code for prototyping
    // int N = 40;
    // int N = 8376000; // this should work for 512M machine
    // int N = 8388608;  // 2^20
    // int N = 16777216; // 2^24
    // int N = 67108864;  // 2^26
    // int N = 1073741824;  // 2^30 takes 10 seconds to generate the string
    ...
    double total_start=c_get_wtime();
