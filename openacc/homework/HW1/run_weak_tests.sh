  ...
  do
    ...
    do
     ...
     # run the problem size
       #for problem_size in 25000000 50000000 100000000 200000000 400000000 800000000
       #do
        if [  "$num_threads" == "1"  ]; then
          command="./countSort_seq -n$problem_size"
        else
          command="./countSort_omp -n $problem_size -t $num_threads"
        fi
